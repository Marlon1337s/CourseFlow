...
public class TestForm extends javax.swing.JFrame {
    ...
    private Object[] getRandomRow(String name) {
        ...
        return new Object[]{false, name, "$"  , "$"  , "0"};
    }
    ...
    private void applyTableStyle(JTable table) {
        ...
        cmdAdd.setIcon(new FlatSVGIcon("Front/Curse/Svg/add.svg", 0.35f));
        cmdUpdate.setIcon(new FlatSVGIcon("Front/Curse/Svg/edit.svg", 0.35f));
        cmdDelete.setIcon(new FlatSVGIcon("Front/Curse/Svg/delete.svg", 0.35f));

        txtSearch.putClientProperty(FlatClientProperties.TEXT_FIELD_TRAILING_ICON, new FlatSVGIcon("Front/Curse/Svg/search.svg", 0.35f));
        //  Change scroll style
