...
public class Turma extends Conexao_bd {
	...
	public ResultSet turmaConsulta(){
        final String SQL = "SELECT id_turma, professor_turma, curso_turma, data_inicio_turma, data_termino_turma, turno_turma, horario_aulas, status_turma FROM tbl_turma;";
        try{
        	conectar();
	...
	public ResultSet turmaConsultaEspecifica() throws SQLException {
        final String sql = "SELECT * FROM tbl_turma WHERE cod_interno = " + codTurma + ";";
